...
$(document).ready(function() {
  ...
  $('.file_list_container h2').each(function(){
    ...
    $('.group_tabs').append('<li><a href="#' + container_id + '">' + group_name.substring(0, 30) + '</a></li>');
  });
  ...
  $('.source_table.highlighted li.covered').live('click', function() {
    const exampleRefs = $(this).children('.deprecations_collector')[0].dataset.exampleRefs.split(",");
    if(!$(this).children('.deprecations_collector').is(':visible')){
      let treeData = [];
      const self = this;
      ...
      const domElement = self.querySelector('.deprecations_collector');
      ...
      $(this).children('.deprecations_collector').show();
      ...
      $(this).children('.deprecations_collector').html('');
      $(this).children('.deprecations_collector').hide();
    }
  });
  $('.source_table.highlighted li.covered .deprecations_collector').live('click', function(event) {
